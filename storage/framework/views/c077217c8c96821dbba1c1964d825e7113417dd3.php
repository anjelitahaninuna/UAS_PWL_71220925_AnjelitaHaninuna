<?php $__env->startSection('title','.:HomeVisit:.'); ?>
        ...
        <div class="col-md-4 mb-4">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <a href="/detail/<?php echo e($pr->id); ?>" class="btn btn-dark">Lihat Detail</a>
            </div>
          </div>
        </div>
...
<?php echo $__env->make("layouts.mainVisit", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\pwblanjut\lunara\resources\views/homeVisit.blade.php ENDPATH**/ ?>